...
// Author / Maintainer: Bob.Paydar@hp.com
//
// Features:
...
//   - Real status bar at the bottom with fixed text: "Ready - Bob.Paydar@hp.com".
...
LRESULT CALLBACK WndProc(HWND h, UINT m, WPARAM w, LPARAM l) {
    ...
    case WM_CREATE: {
        ...
        SendMessageW(g.hStatus, SB_SETTEXT, 0, (LPARAM)L"Ready - Bob.Paydar@hp.com");
